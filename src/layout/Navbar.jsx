...
const [isScrolled, setIsScrolled] = useState(false);
    ...
    return(
     <header className={`fixed top-0 left-0 right-0  z-50 ${isScrolled ? 'glass-strong py-3' : 'bg-transparent py-5'}`}>
        <nav className="container mx-auto px-6 flex items-center justify-between">
            <a href="#" className="text-xl italic  font-bold tracking-tight hover:text-primary">
                JU<span className="text-primary">.</span>
            </a>
